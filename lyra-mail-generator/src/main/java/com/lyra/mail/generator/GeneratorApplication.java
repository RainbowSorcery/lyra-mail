...
public class GeneratorApplication {
    public static void main(String[] args) {
        ...
        try {
            ...
            Connection conn = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/wiki", "root", "365373011");
            ...
            while (resultSet.next()) {
                ...
                String tableName = resultSet.getString("Tables_in_wiki");

                if (!tableName.contains("qrtz")) {

                    FastAutoGenerator.create("jdbc:mysql://127.0.0.1:3306/wiki", "root", "365373011")
                            ...
                            .packageConfig(builder -> {
                                builder.parent("com.lyra.wiki") // 设置父包名 // 设置父包模块名
